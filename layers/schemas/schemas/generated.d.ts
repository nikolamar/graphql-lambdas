...
export type CognitoResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["Cognito"] = ResolversParentTypes["Cognito"],
> = {
...
> = {
  ...
  >;
  deleteManyTenants?: Resolver<
    ResolversTypes["Int"],
    ParentType,
    ContextType,
    RequireFields<MutationDeleteManyTenantsArgs, "where">
  >;
  deleteManyUsers?: Resolver<
    ResolversTypes["Int"],
    ParentType,
    ContextType,
    RequireFields<MutationDeleteManyUsersArgs, "where">
  >;
  deleteTenant?: Resolver<
    ResolversTypes["Int"],
    ParentType,
    ContextType,
    RequireFields<MutationDeleteTenantArgs, "where">
  >;
  ...
  updateTenant?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationUpdateTenantArgs, "input" | "where">
  >;
  updateUser?: Resolver<
    ResolversTypes["User"],
    ParentType,
...
export type TenantEdgeResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["TenantEdge"] = ResolversParentTypes["TenantEdge"],
> = {
...
export type TenantsResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["Tenants"] = ResolversParentTypes["Tenants"],
> = {
...
export type TermsAndConditionsMetaDataResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["TermsAndConditionsMetaData"] = ResolversParentTypes["TermsAndConditionsMetaData"],
> = {
